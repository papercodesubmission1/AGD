...
class GATConv(MessagePassing):
    ...
    def forward(self, x: Union[Tensor, OptPairTensor], edge_index: Adj, edge_weight: OptTensor,
        ...
        # print(x_l.shape,x_r.shape,alpha_r.shape,alpha_r.shape)
    ...
    def att_norm(self, edge_weight, index, num_nodes=None):
        deg = scatter_add(edge_weight, index, dim=0, dim_size=None)
        deg_inv_sqrt = deg.pow_(-1)
        deg_inv_sqrt.masked_fill_(deg_inv_sqrt == float('inf'), 0)
        return deg_inv_sqrt[index] * edge_weight
